...
<body>
    ...
    <div style="justify-content: center" class="container">
        ...
        <button type="button" onclick="window.location.href='adminListHotels.jsp'" class="btn btn-secondary">Back</button>

    </div>
    <%
        } catch (SQLException sqle) {
    %>
        <div class='alert alert-danger' role='alert'>An error has ocurred</div>
    <%
        }
    %>
</body>
